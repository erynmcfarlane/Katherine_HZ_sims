...
N_markers<-c(10000000, 100000000, 100000000)
...
slim_script(
  slim_block (initialize(),
         ...
         initializeRecombinationRate(1e-8);
                ...
                multipliers = rlnorm(10000, 0.0, 0.75);
 ...
 m4.colorSubstitution = "green";
  ...
  slim_block(3505, late(), ## 10 generations of hybridization - can change if needed, but likely won't vary this.
             
             {
               ...
               file_path = r_inline(paste0("test", "m", migration_choices[i], "pop", number_of_pops[j],"N_markers", N_markers[k],"_50_individuals", ".vcf")) ### also need to change here
...
outputcommand<-paste("cp", script_2_run$output_file, paste0("./", "m", migration_choices[i],"pop", number_of_pops[j],"N_markers", N_markers[k], "_50_individuals", ".txt"))
