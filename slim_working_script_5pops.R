...
outputcommand<-paste("cp", script_2_run$output_file, paste0("./", "m", migration_choices[i],"pop", number_of_pops[j],"N_markers", N_markers[k], ".txt"))
